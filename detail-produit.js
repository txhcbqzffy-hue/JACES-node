(function () {
    ...
    function renderResult() {
      ...
      return `
        <div class="size-advisor-shell size-advisor-result">
          ...
          <p class="size-advisor-result-note">Notre recommandation pour cette pièce, selon les informations renseignées.</p>
        ...
        content = `
          <div class="size-advisor-shell">
            ...
            <div class="size-advisor-intro">
              <h2>Trouvez votre taille idéale pour cette pièce</h2>
  ...
  async function renderDetailPage() {
    ...
    document.getElementById('detail-size-advisor')?.addEventListener('click', () => {
      openSizeAdvisor(product, sizeInput?.value || '', (recommendedSize) => {
